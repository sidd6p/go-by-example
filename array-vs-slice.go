...
copy(a, c) When copying a slice, it creates a shallow copy of the elements, meaning it copies the values but doesn't create a new underlying array.
For arrays, since their size is fixed, you would generally assign them directly, which creates a copy.
*/
